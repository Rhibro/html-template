...
if (triangleOne > triangleTwo) {
   console.log("Triangle One is biggest!")
} else if (triangleTwo > triangleOne) {
    console.log("Triangle Two is biggest!")
}
...
if (triangleThree > triangleFour) {
    console.log("Triangle Three is biggest!");
} else if (triangleFour > triangleThree) {
    console.log("Triangle Four is biggest!");
} else if (triangleFour === triangleThree) {
    console.log("Triangle Four and Five are equal in size!");
}
...
if (triangleFive > triangleSix) {
    console.log("Triangle Five is biggest!")
